...
QT_MOC_LITERAL(3, 20, 12), // "forceChanged"
QT_MOC_LITERAL(4, 33, 9), // "MoveToLog"
QT_MOC_LITERAL(5, 43, 4), // "text"
QT_MOC_LITERAL(6, 48, 12), // "removeNeeded"
QT_MOC_LITERAL(7, 61, 5), // "index"
QT_MOC_LITERAL(8, 67, 12), // "sendFileData"
QT_MOC_LITERAL(9, 80, 4), // "file"
QT_MOC_LITERAL(10, 85, 5) // "force"

    },
    "Thread\0fileChanged\0\0forceChanged\0"
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::fileChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Thread::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::forceChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::MoveToLog)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::removeNeeded)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void Thread::fileChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Thread::forceChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Thread::MoveToLog(QString _t1)
{
...
// SIGNAL 3
void Thread::removeNeeded(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
